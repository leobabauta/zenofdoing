...
export function PracticeTimer({ onBack, onContinue }: PracticeTimerProps) {
      ...
      {showCelebration ? (
        <div className="flex flex-col items-center py-10 gap-5">
          ...
          <div className="flex items-center gap-3 mt-4">
            <button
              onClick={onContinue}
              className="flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-semibold tracking-wide text-white transition-colors"
        ...
        <div className="flex flex-col items-center py-6 gap-5">
          ...
          >
            ...
            {darkPiePath && (
              <path d={darkPiePath} fill={accentDark} opacity={0.45} />
            )}
            {ticks}
            <line
              x1={cx}
